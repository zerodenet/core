...
pub use model::{
    ...
    H2Config, HookConfig, HttpUpgradeConfig, Hysteria2BandwidthConfig, Hysteria2BandwidthValue,
    Hysteria2CongestionConfig, Hysteria2MasqueradeConfig, Hysteria2QuicConfig,
    Hysteria2TransportConfig, Hysteria2UserConfig, InboundConfig, InboundProtocolConfig,
