...
impl Hasher {
    ...
    pub fn new_derive_key(context: &str) -> Self {
        Self::new_derive_key_bytes(context.as_bytes())
    }

    /// Create a key-derivation hasher with a binary context.
    ///
    /// This is the byte-preserving equivalent of `new_derive_key`, for wire
    /// protocols whose domain separation context is not necessarily UTF-8.
