...
pub struct ClientConfig {
    /// Optional per-connection ClientHello presentation. Cryptographic state remains owned
    /// by rustls; profiles cannot add negotiable algorithms absent from the provider.
    pub client_hello_profile: Option<Arc<dyn super::hello_profile::ClientHelloProfileProvider>>,
